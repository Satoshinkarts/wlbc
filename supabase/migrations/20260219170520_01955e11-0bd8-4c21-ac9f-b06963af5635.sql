...
BEGIN
  ...
  -- Volume discount only for PVA - Gmail products
...
-- Drop the old 4-arg overload to prevent confusion
DROP FUNCTION IF EXISTS public.validate_and_create_order(jsonb, text, text, text);
